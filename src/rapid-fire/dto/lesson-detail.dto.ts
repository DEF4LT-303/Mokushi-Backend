...
export class RapidFireLessonOverviewDto {
  ...
  @ApiProperty({
    enum: JlptLevel,
    description: "JLPT level associated with the lesson",
  })
  jlptLevel!: JlptLevel;

  @ApiProperty({
    type: [RapidFireWordDto],
    description: "Rapid-fire word bank for the lesson",
  })
  words!: RapidFireWordDto[];

  @ApiProperty({
    type: RapidFireLessonStatDto,
    description: "Lesson-specific rapid-fire statistics",
  })
  ...
  @ApiProperty({
    ...
    description:
      "Overall rapid-fire progress for the current user and JLPT level",
  })
