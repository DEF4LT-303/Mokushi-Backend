...
export class QuizConfigInputDto {
  @ApiProperty({
    description:
      'Name of the quiz configuration (e.g., "10 Questions - 5 Minutes")',
  })
  @IsString()
  name!: string;

  @ApiProperty({
    description: "Number of questions for this quiz configuration",
  })
  @IsInt()
  @Min(1)
  numQuestions!: number;
...
export class CreateModuleDto {
  ...
  @ApiPropertyOptional({
    description: "Optional Rule ID associated with this module",
  })
  @IsOptional()
  @IsString()
  ruleId?: string;
  ...
  @ApiPropertyOptional({
    description:
      "Optional array of quiz configurations to create with this module",
