...
export class CreateGrammarRuleDto {
  ...
  @ApiPropertyOptional({
    description: "Romaji reading of the grammar expression",
  })
  @IsOptional()
  @IsString()
  romaji?: string;
  ...
  @ApiPropertyOptional({
    description: "Optional structure pattern for the rule",
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: "Optional examples to create with the grammar rule",
