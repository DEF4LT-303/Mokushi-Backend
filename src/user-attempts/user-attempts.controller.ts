...
export class UserAttemptsController {
  ...
  @ApiOperation({
    summary:
      "Start a user quiz attempt. [Called on /api/modules/{id}/quiz automatically]",
  })
  @ApiBearerAuth()
  ...
  @ApiOperation({
    summary:
      "Submit answers for a user attempt (bulk). [Called on /api/modules/quiz/submit automatically]",
  })
  @ApiBearerAuth()
  @ApiUnauthorizedResponse({ description: "Unauthorized" })
  @ApiForbiddenResponse({ description: "Forbidden" })
  ...
  submitAnswers(
    @Param("id") id: string,
    @Body() answers: CreateUserAnswerDto[],
  ) {
  ...
  @ApiForbiddenResponse({ description: "Forbidden" })
  @ApiOkResponse({
    type: QuizHistoryDetailedDto,
    description: "Detailed quiz history",
  })
