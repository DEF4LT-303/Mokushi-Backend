...
export class LeaderboardController {
  ...
  @ApiOperation({
    summary:
      "Get categorized leaderboard with global and module-specific rankings",
  })
  @ApiQuery({
    name: "jlptLevel",
    required: false,
  ...
  @ApiOkResponse({
    description:
      "Categorized leaderboard with Global Program, Grammar, Vocabulary, and Listening rankings",
